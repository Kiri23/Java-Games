...
public class Game {
	...
	public void update(){
		...
		if(waveManager.getWaveNumber() + 1 == 2){
			waveManager.setEnemyType(new Enemy(quickLoad("DirtTile"), grid.getTile(5,9),grid, 64, 64, 70,45));
		}else 
			
			waveManager.setEnemyType(new Enemy(quickLoad("EnemyTile"), grid.getTile(5,9),grid, 64,64, 70,20));
